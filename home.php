...
<main role="main">
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            <div class="row">
                <?php $p = new Produto();
                foreach ($p->querySeleciona() as $rst) {


                    ?>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <?php echo "<img class='card-img-top' src='sistema/Controller/imagem/" . $rst["foto"] . " ' /> " ?>
                            <div class="card-body">
                                <h3 class="card-text"><?php echo $rst ["nome"]; ?></h3>
                                <p class="card-text"> Categoria: <?php echo $rst ["categoria"]; ?></p>

                                <p  class="card-text">R$: <?php echo $rst ["preco"]; ?> </p>
                                <p class="card-text"><?php echo $rst ["mensagem"]; ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Detalhes</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Adicionar ao
                                            carrinho de compras
                                        </button>
                                    </div>
                                </div>
